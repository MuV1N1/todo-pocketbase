...
var RecordService = class extends CrudService {
  ...
  async confirmEmailChange(e2, t2, s2, i2) {
    ...
    return n = normalizeLegacyOptionsArgs("This form of confirmEmailChange(token, password, body?, query?) is deprecated. Consider replacing it with confirmEmailChange(token, password, options?).", n, s2, i2), this.client.send(this.baseCollectionPath + "/confirm-email-change", n).then(() => {
      const t3 = getTokenPayload(e2), s3 = this.client.authStore.model;
